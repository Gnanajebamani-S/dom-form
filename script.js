function foo() {
  var first1 = document.getElementById("firstname").value;
  console.log(`First name:${first1}`);
  var middle1 = document.getElementById("middlename").value;
  console.log(`Middle name:${middle1}`);
}
